...
def build_install_plan(
    *,
    ...
    actions = [
        ...
        InstallAction("uzdoom-launchers", "Create UZDoom classic/modern/modded config templates and Steam launch metadata"),
        InstallAction("steam-input-profile", "Generate a DoomDeck Steam Input keyboard/mouse profile for the Doom Runner shortcut"),
