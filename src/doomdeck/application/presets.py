        ...
        if brutal_mod:
            presets.append(
                Preset(
                    ...
                    iwad=default_iwad,
                    files=(brutal_mod,),
                    config=dirs.uzdoom_config / "brutal" / "uzdoom.ini",
                    autoexec=dirs.uzdoom_config / "brutal" / "autoexec.cfg",
        ...
        if project_brutality_mod:
            presets.append(
                Preset(
                    ...
                    config=dirs.uzdoom_config / "project-brutality" / "uzdoom.ini",
                    autoexec=dirs.uzdoom_config / "project-brutality" / "autoexec.cfg",
